...
export default function DocumentManagementOnboardingPage() {
  ...
  const fetchDocs = async () => {
    ...
    try {
      ...
      const normalized = (data.documents || []).map((d: any) => ({
        ...
        archived: Boolean(
          d.archived ?? d.is_archived ?? d.isArchived ?? d.archived_at ?? d.archivedAt
        ),
      }));
      setDocs(normalized);
  ...
  function RowActions({ doc }: { doc: Document }) {
    ...
    const computePos = () => {
      ...
      setPos({
        top: spaceBelow < menuHeightGuess ? r.top - gap : r.bottom + gap,
        left: r.left,
        width: Math.max(180, r.width),
        openUp: spaceBelow < menuHeightGuess,
      });
    };
    useEffect(() => {
      if (!open) return;
  ...
  const goToArchived = (archived: boolean) => {
    const q = new URLSearchParams(params.toString());
    if (archived) q.set("archived", "1");
    else q.delete("archived");
    const qs = q.toString();
    router.push(`/dashboard/admin/document-management/onboarding${qs ? `?${qs}` : ""}`);
  };
    ...
    <div>
      ...
      <div className="bg-white p-4 rounded shadow-sm mb-4">
        <div className="flex items-center justify-between mb-4 flex-wrap gap-4">
          ...
          <div className="flex items-center space-x-2">
            <button
              onClick={() => goToArchived(!showArchived)}
                            ...
                            >
                              {[
                                ...
                                <button
                                  ...
                                  type="button"
                                  onClick={() => {
                                    setMappedFilter(opt.key as typeof mappedFilter);
                                    setMappedMenuOpen(false);
                                    setCurrentPage(1);
                                  }}
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full min-h-[100px] px-3 py-2 border border-gray-400 text-sm outline-none focus:border-gray-600 resize-none"
                    />
                  </div>
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-gray-700 mb-2">
                      Users to receive Completed Notification Email(s):
                    </label>
                  ...
                  <div className="mt-4">
                    ...
                    <div className="flex items-center justify-center gap-2 mt-3">
                      ...
                      <button
                        onClick={closeModal}
                        className="px-5 py-2 border border-gray-400 text-xs rounded hover:bg-gray-50"
                      >
                        Cancel
                      </button>
                    </div>
