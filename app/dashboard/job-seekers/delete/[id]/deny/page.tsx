...
export default function DenyJobSeekerDeletePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`/api/job-seekers/delete/${deleteRequestId}/deny`, {
        method: "POST",
        headers: {
      ...
      <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full">
        {status === "form" && (
          <form onSubmit={handleSubmit} className="space-y-4">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Deny Delete Request (Job Seeker)</h2>
            <div>
