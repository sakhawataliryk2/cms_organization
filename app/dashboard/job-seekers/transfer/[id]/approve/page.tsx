  ...
  useEffect(() => {
    ...
    const approveTransfer = async () => {
      try {
        ...
        const response = await fetch(`/api/job-seekers/transfer/${transferId}/approve`, {
          method: "POST",
          headers: {
      ...
      <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full">
        ...
        {status === "success" && (
          <div className="text-center">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-2">Job Seeker Transfer Approved</h2>
