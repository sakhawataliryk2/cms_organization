...
const PLACEMENT_SEGMENT = "executive-search" as const;
const EXPECTED_JOB_TYPE = "executive";
...
export default function AddPlacement() {
  ...
  } = useCustomFields("placements-executive-search");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const apiData: Record<string, any> = {
        placement_type: "Executive Search"
      };
      ...
      <div className="mx-auto py-4 px-4 sm:py-8 sm:px-6">
        <div className="bg-white rounded-lg shadow p-4 sm:p-6">
          <div className="border-b pb-4 mb-6 flex justify-between items-center">
            <h1 className="text-xl font-bold">Add Placement Executive Search</h1>
          ...
          <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 text-amber-800 mb-4">
            <p className="font-medium">This job&apos;s type doesn&apos;t match an Executive Search placement.</p>
      ...
      <div className="bg-white rounded-lg shadow p-4 sm:p-6 relative">
        <div className="flex justify-between items-center border-b pb-4 mb-6 flex-wrap gap-2">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold">{isEditMode ? "Edit" : "Add"} Placement Executive Search</h1>
          </div>
